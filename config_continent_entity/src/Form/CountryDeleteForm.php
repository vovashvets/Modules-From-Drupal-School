...
/**
 * Class CountryDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from CountryFormBase. The reason for
 ...
 * @ingroup country
 */
class CountryDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete country %label?', [
  ...
  public function getCancelUrl() {
    return new Url('entity.country.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('Country %label was deleted.', [
      '%label' => $this->entity->name,
    ]));
