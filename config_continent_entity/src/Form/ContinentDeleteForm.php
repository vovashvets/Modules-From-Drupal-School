...
/**
 * Class ContinentDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from ContinentFormBase. The reason for
 ...
 * @ingroup continent
 */
class ContinentDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete continent %label?', [
  ...
  public function getConfirmText() {
    return $this->t('Delete Continent');
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.continent.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('Continent %label was deleted.', [
      '%label' => $this->entity->name,
    ]));
