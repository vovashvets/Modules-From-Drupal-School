 ...
 *   handlers = {
 *     "access" = "Drupal\config_continent_entity\CountryAccessController",
 *     "list_builder" = "Drupal\config_continent_entity\Controller\CountryListBuilder",
 *     "form" = {
 *       "add" = "Drupal\config_continent_entity\Form\CountryAddForm",
 *       "edit" = "Drupal\config_continent_entity\Form\CountryEditForm",
 *       "delete" = "Drupal\config_continent_entity\Form\CountryDeleteForm"
 *     }
 *   },
 *   entity_keys = {
 *     "id" = "id",
 ...
 *   },
 *   links = {
 *     "edit-form" = "/countries/manage/{country}",
 *     "delete-form" = "/countries/manage/{country}/delete"
 *   },
 *   config_export = {
 *     "id",
 *     "name",
...
class Country extends ConfigEntityBase {
  ...
  /**
   * The country Continent Id (Machine Name).
   *
   * @var string
   */
  public $continent_id;
