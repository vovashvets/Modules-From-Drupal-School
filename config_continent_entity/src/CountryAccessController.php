 ...
 *
 * We set this class to be the access controller in Country's entity annotation.
 *
 * @see \Drupal\continent\Entity\Country
 *
 * @ingroup continent
 */
class CountryAccessController extends EntityAccessControlHandler {
